...
class _ApiService implements ApiService {
  ...
  @override
  Future<LoginResponse> login(LoginRequistBody loginRequistBody) async {
  ...
  Future<ForgetPasswordResponse> forgetPassword(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(forgetPassworsRequestModel.toJson());
  ...
  Future<GetProfileModel> getProfile() async {
    ...
    final _options = _setStreamType<GetProfileModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<ImageDetectionResponseModel> imageDetection(File image) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<ImageDetectionResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'multipart/form-data',
        ...
        .compose(
          _dio.options,
          'https://cashwa-nodejs-server.fly.dev/api/vi/process-image',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ImageDetectionResponseModel _value;
    try {
      _value = ImageDetectionResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
