...
mixin _$ResetPasswordState<T> {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(_ResetPasswordInitial<T> value) initial,
    required TResult Function(ResetPasswordLoding<T> value) loading,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(_ResetPasswordInitial<T> value)? initial,
    TResult? Function(ResetPasswordLoding<T> value)? loading,
...
/// @nodoc
abstract class _$$ResetPasswordLodingImplCopyWith<T, $Res> {
  factory _$$ResetPasswordLodingImplCopyWith(_$ResetPasswordLodingImpl<T> value,
          $Res Function(_$ResetPasswordLodingImpl<T>) then) =
      __$$ResetPasswordLodingImplCopyWithImpl<T, $Res>;
}

/// @nodoc
class __$$ResetPasswordLodingImplCopyWithImpl<T, $Res>
    extends _$ResetPasswordStateCopyWithImpl<T, $Res,
        _$ResetPasswordLodingImpl<T>>
    implements _$$ResetPasswordLodingImplCopyWith<T, $Res> {
  __$$ResetPasswordLodingImplCopyWithImpl(_$ResetPasswordLodingImpl<T> _value,
      $Res Function(_$ResetPasswordLodingImpl<T>) _then)
      : super(_value, _then);
...
class _$ResetPasswordLodingImpl<T> implements ResetPasswordLoding<T> {
  const _$ResetPasswordLodingImpl();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ResetPasswordLodingImpl<T>);
  }
...
abstract class ResetPasswordLoding<T> implements ResetPasswordState<T> {
  const factory ResetPasswordLoding() = _$ResetPasswordLodingImpl<T>;
}
...
class _$ResetPasswordSuccessImpl<T> implements ResetPasswordSuccess<T> {
  ...
  @override
  String toString() {
    return 'ResetPasswordState<$T>.success(message: $message)';
  }
